$(function () {
  ...
  var dataComprasAcumulado = {
    labels: ["3", "5", "7", "8", "9", "13", "22", "24", "25", "29"],
    datasets: [
      {
        label: "$",
        data: [
          1250, 850, 3500, 300, 1200, 3500, 1250, 850, 3500, 300, 1200, 3500,
        ],
        backgroundColor: [
          "rgba(255, 99, 132, 0.2)",
          "rgba(54, 162, 235, 0.2)",
  ...
  if ($("#montoCompras").length) {
    var montoComprasChart = $("#montoCompras").get(0).getContext("2d");
    var montoChart = new Chart(montoComprasChart, {
      type: "line",
      data: dataComprasAcumulado,
      options: areaOptions,
    });
  }
