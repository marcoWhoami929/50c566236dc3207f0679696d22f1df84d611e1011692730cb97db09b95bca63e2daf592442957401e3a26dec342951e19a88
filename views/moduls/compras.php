                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-2  col-sm-2">
                                ...
                                <select class="form-control" id="sucursal" onchange="cargarCompras(1);">
                            ...
                            <div class="col-lg-2 col-md-2  col-sm-2">
                                ...
                                <select class="form-control" id="estatus" onchange="cargarCompras(1);">
                            ...
                            <div class="col-lg-2 col-md-2  col-sm-2">
                                ...
                                <select class="form-control" id="estado" onchange="cargarCompras(1);">
                                    <option value="">Todos</option>
                            ...
                            <div class="col-lg-2 col-md-2  col-sm-2">
                                ...
                                <select class="form-control" id="per_page" onchange="cargarCompras(1);">
                                    <option>5</option>
                                    <option>10</option>
                            ...
                            <div class="col-lg-4 col-md-4  col-sm-4">
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3">
                                        <button type="button" class="btn btn-danger btn-rounded btn-icon" onclick="cargarCompras(1);">
                                            <i class="ti-search"></i>
                                        </button>
                                    </div>
                                </div>
...
<div class="modal fade" id="modalVerDetalleCompra" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">

                <button type="button" class="btn btn-success btn-rounded btn-icon" data-dismiss="modal" aria-label="Close" onclick="eliminarProductos();">
                    <i class="ti-close"></i>
                </button>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-8 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body" id="detalleCompras">
                                <h4 class="card-title">Detalle</h4>
                                  <p class="card-description">
                                    
                                  </p>
                                  <div class="table-responsive">
                                    <table class="table" id="tablaDetalleCompras">
                                      <thead>
                                        <tr>
                                          <th>Codigo</th>
                                          <th>Descripcion</th>
                     ...
                     <div class="col-md-4 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Venta Por Marca</h4>
                                  <p class="card-description">
                                    
                                  </p>
                                  <div class="table-responsive">
                                    <table class="table" id="tablaDetalleMarca">
                                      <thead>
                                        <tr>
                                          <th>Marca</th>
                                          <th>Monto</th>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info" id="salir" data-dismiss="modal" onclick="eliminarProductos();">Salir</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    if (URLactual == "http://localhost/DEKKERADMIN/compras") {
